...
let isLazuriteIotConfigReady = false;
function LazuriteIot(RED) {
	let node = this;
	const fs = require("fs");
	const https = require("https");
	let mqtt = require('mqtt');
	let rf =  require("../../build/Release/lazurite_wrap")
	function LazuriteIotDeviceManager(config) {
	...
	*/
	...
	RED.nodes.registerType("lazurite-iot-device-manager",LazuriteIotDeviceManager);

	function LazuriteIotConfig(config) {
		RED.nodes.createNode(this,config);
		let node = this;
		if(isLazuriteIotConfigReady === false) {
	...
	RED.nodes.registerType("lazurite-iot-channel",LazuriteIotConfig);
}
